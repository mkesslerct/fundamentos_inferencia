...
En cambio, si consideramos el ejemplo de una encuesta para estimar la tasa de participación, se trata de una extracción sin reemplazo. Si $N$ es el tamaño del censo y  $X_1, X_2, \ldots, X_n$ representan las respuestas obtenidas al preguntar a personas de manera consecutiva, la probabilidad $\mathbb{P}(X_i = Si)$ se calcula como  $\frac{1}{N - (i - 1)} p$.
